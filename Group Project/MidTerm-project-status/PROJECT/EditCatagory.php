...
<body>
	<form action="" method="post">
		<table align="center" style="border:2px solid Orange;">
			<tr>
				<td colspan="2" align="center"><h1 style="color:orange"><b>Update Catagory</b></h1></td>
			</tr>
			<tr>
				<td align="right">Catagory Number*</td>
				<td><input name="catagoryNumber" value="<?php echo $catagoryNumber;?>" type="text"><br>
					<span><?php echo $err_catagoryNumber;?></span>
				</td>
			</tr>
			<tr>
	...
	<form>
		<table align="center" style="border:2px solid Red;">
			<tr>
				<td colspan="2" align="center"><h1 style="color:red"><b>Delete Catagory</b></h1></td>
			</tr>
			<tr>
				<td align="right">Catagory Number*</td>
				<td><input name="catagoryNumber" value="<?php echo $catagoryNumber;?>" type="text"><br>
