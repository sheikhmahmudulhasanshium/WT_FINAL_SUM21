		...
		<table align="center">
			<tr>
				<td rowspan="10" align="center">
					...
					<table>
					<tr>
						<td colspan="2" align="center"><h2><b>InterContinental Residence <br> Suites</b></h2></td>
					</tr>
					<tr>
...
if($username=="zubairahmed")
{
	...
	{
	require("Receiptionist_panel.php");
	}
	else
	{ 
	$err_password = "Invalid password";
...
if($username=="onturahman")
{
	...
	{
	require("customer_panel.php");//customer_panel
	}
	else
	{ 
	$err_password = "Invalid password";
